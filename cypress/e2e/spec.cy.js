describe("Page load", () => {
  ...
  it("should display title and existing shortened urls", () => {
    ...
    cy.get(".short-url-link")
      .should("exist")
      .should("contain", "http://localhost:3001/useshorturl/3");
    cy.get(".long-url-link")
      .should("exist")
      .should(
        "contain",
        "https://www.ticketmaster.com/phoenix-suns-vs-golden-state-warriors-phoenix-arizona-11-16-2022/event/19005D0B8F9F1519"
      );
  });
  ...
  it("should display user input correctly within the input fields", () => {
    ...
    cy.get('[placeholder="URL to Shorten..."]').type(
      "https://www.google.com/search?q=google+images+of+schnauzers&sxsrf=ALiCzsYcItTS_AxMVKpnvUphREik2FRG2A:1668535532095&source=lnms&tbm=isch&sa=X&ved=2ahUKEwj42r2d47D7AhUSMjQIHf-DD5kQ_AUoAXoECAEQAw&biw=1920&bih=944&dpr=1"
    );
  });
  ...
  it("should render new shortened URL when user submits the form", () => {
    ...
    cy.get(":nth-child(2) > h3")
      .should("exist")
      .should("contain", "My favorite dogs");
    cy.get(":nth-child(2) > .short-url-link")
      .should("exist")
      .should("contain", "http://localhost:3001/useshorturl/4");
    cy.get(":nth-child(2) > .long-url-link")
      .should("exist")
      .should(
        "contain",
        "https://www.google.com/search?q=google+images+of+schnauzers&sxsrf=ALiCzsYcItTS_AxMVKpnvUphREik2FRG2A:1668535532095&source=lnms&tbm=isch&sa=X&ved=2ahUKEwj42r2d47D7AhUSMjQIHf-DD5kQ_AUoAXoECAEQAw&biw=1920&bih=944&dpr=1"
